...
int main()
{
    ...
    */
    ...
    while (!flag)
    {
        ...
        {
            dataBLL.insertLL(dataB, i); //change data between set A and B
        }
    ...
    while (!flag)
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            dataBLL.searchLL(dataB[randIndex[i]]); // change to dataset B
        }
    ...
    ofstream oFile;
    oFile.open("insertTimesLL_B.csv"); // change titles between data sets
    for (int i = 0; i < insertTime.size(); i++)
    {
    ...
    oFile.open("searchTimesLL_B.csv"); // change titles between data sets
    for (int i = 0; i < searchTime.size(); i++)
    {
