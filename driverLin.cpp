...
int main()
{
    ...
    */
    ...
    ofstream oFile;
    oFile.open("insertTimesHashLin_A.csv"); // change titles between data sets
    ...
    oFile.open("insertCollisionsHashLin_A.csv"); // change titles between data sets
    for (int i = 0; i < insertTime.size(); i++)
    {
    ...
    oFile.open("searchTimesHashLin_A.csv"); // change titles between data sets
    ...
    oFile.open("searchCollisionsHashLin_A.csv"); // change titles between data sets
    for (int i = 0; i < insertTime.size(); i++)
    {
